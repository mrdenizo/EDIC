...
namespace EDIC
{
    class OAuth2
    {
        private static readonly string ClientID = "a3348995-bf6b-4930-ab21-7931d22509d6";
        private static readonly string AppName = "Elite:Dangerous Inara connector";
        private const string Scope = "auth";
        ...
        public class OAuth2Request : IOAuth2Request, IDisposable
        {
            ...
            private void EndGetContext(IAsyncResult target)
            {
                ...
                HttpWebRequest httpreq = (HttpWebRequest)HttpWebRequest.Create(tokenurl);
